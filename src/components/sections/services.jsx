            ...
            <div className="container" data-aos="fade-up">
                ...
                <div className="row gy-4">
                    ...
                    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div className="card">
                            <div className="card-img">
                                <img src="images/services/img5.jpg" alt="" className="img-fluid" />
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div className="card">
                            <div className="card-img">
                                <img src="images/services/img4.jpg" alt="" className="img-fluid" />
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div className="card">
                            <div className="card-img">
                                <img src="images/services/img6.jpg" alt="" className="img-fluid" />
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div className="card">
                            <div className="card-img">
                                <img src="images/services/img7.jpg" alt="" className="img-fluid" />
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                        <div className="card">
                            <div className="card-img">
                                <img src="images/services/img8.jpg" alt="" className="img-fluid" />
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                        <div className="card">
                            <div className="card-img">
                                <img src="images/services/img9.jpg" alt="" className="img-fluid" />
                            </div>
