  ...
  return (
    <>
              ...
              <div className="row gy-4" data-aos="fade-up" data-aos-delay="400">
                ...
                <div className="col-lg-3 col-6">
                  <div className="stats-item text-center w-100 h-100">
                    ...
                    <p>Air Quality Index</p><i class="bi bi-arrow-left-square-fill"><BsFillArrowLeftSquareFill /></i>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up">
                ...
                <div>
                  ...
                  <a href="service-details.html" class="readmore stretched-link"><span>Learn More</span><i
                    class="bi bi-arrow-right"><BsArrowRight /></i></a>
                </div>
              </div>
          ...
          <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="card">
                  <div class="card-img">
                    <img src="src/assets/img/img5.jpg" alt="" class="img-fluid" />
                  </div>
                  <h3><a href="service-details.html" class="stretched-link">Air Quality Index</a></h3>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="card">
                  <div class="card-img">
                    <img src="src/assets/img/img4.jpg" alt="" class="img-fluid" />
                  </div>
                  <h3><a href="service-details.html" class="stretched-link">Plant Recommendation</a></h3>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="card">
                  <div class="card-img">
                    <img src="src/assets/img/img6.jpg" alt="" class="img-fluid" />
                  </div>
                  <h3><a href="service-details.html" class="stretched-link">Plant Store</a></h3>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="card">
                  <div class="card-img">
                    <img src="src/assets/img/img7.jpg" alt="" class="img-fluid" />
                  </div>
                  <h3><a href="service-details.html" class="stretched-link">Gardening Tips</a></h3>
                  <p>Dicta quam similique quia architecto eos nisi aut ratione aut ipsum reiciendis sit doloremque oluptatem
                    aut et molestiae ut et nihil</p>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="card">
                  <div class="card-img">
                    <img src="src/assets/img/img8.jpg" alt="" class="img-fluid" />
                  </div>
                  <h3><a href="service-details.html" class="stretched-link">Community</a></h3>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                <div class="card">
                  <div class="card-img">
                    <img src="src/assets/img/img9.jpg" alt="" class="img-fluid" />
                  </div>
                  <h3><a href="service-details.html" class="stretched-link">Enviorment Analysis</a></h3>
        ...
        <section id="features" class="features">
          <div class="container">
            ...
            <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
              ...
              <div class="col-md-5">
                <img src="src/assets/img/features-1.jpg" class="img-fluid" alt="" />
              </div>
              <div class="col-md-7">
            ...
            <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
              <div class="col-md-5 order-1 order-md-2">
                <img src="src/assets/img/features-2.jpg" class="img-fluid" alt="" />
              </div>
            ...
            <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
              <div class="col-md-5">
                <img src="src/assets/img/features-3.jpg" class="img-fluid" alt="" />
              </div>
              <div class="col-md-7">
            ...
            <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
              <div class="col-md-5 order-1 order-md-2">
                <img src="src/assets/img/features-4.jpg" class="img-fluid" alt="" />
              </div>
              <div class="col-md-7 order-2 order-md-1">
      ...
      <a href="#" class="scroll-top d-flex align-items-center justify-content-center"><i
        class="bi bi-arrow-up-short"><BsArrowUpShort /></i></a>
