                        ...
                        <div class="container position-relative">
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-6 text-center">
                                    <h2>Contact</h2>
                                    <p>Plantify strives to respond to inquiries promptly and provide excellent customer service. So, if you have any questions, concerns, or feedback, don't hesitate to reach out to Plantify's customer support team.</p>
                                </div>
                            </div>
                        </div>
                    </div>
