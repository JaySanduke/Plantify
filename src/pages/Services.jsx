                    ...
                    <div class="container" data-aos="fade-up">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                                <div class="card">
                                    <div class="card-img">
                                        <img src="src/assets/img/storage-service.jpg" alt="" class="img-fluid" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="card">
                                    <div class="card-img">
                                        <img src="src/assets/img/logistics-service.jpg" alt="" class="img-fluid" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                                <div class="card">
                                    <div class="card-img">
                                        <img src="src/assets/img/cargo-service.jpg" alt="" class="img-fluid" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                                <div class="card">
                                    <div class="card-img">
                                        <img src="src/assets/img/trucking-service.jpg" alt="" class="img-fluid" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                                <div class="card">
                                    <div class="card-img">
                                        <img src="src/assets/img/packaging-service.jpg" alt="" class="img-fluid" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                                <div class="card">
                                    <div class="card-img">
                                        <img src="src/assets/img/warehousing-service.jpg" alt="" class="img-fluid" />
                                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
                            ...
                            <div class="col-md-7">
                                ...
                                <ul>
                                    <li><i class="bi bi-check"><BsCheck></BsCheck> </i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                                    <li><i class="bi bi-check"><BsCheck></BsCheck></i> Duis aute irure dolor in reprehenderit in voluptate velit.</li>
                                    <li><i class="bi bi-check"><BsCheck></BsCheck></i> Ullam est qui quos consequatur eos accusamus.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
                            ...
                            <div class="col-md-7">
                                ...
                                <ul>
                                    <li><i class="bi bi-check"><BsCheck></BsCheck></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                                    <li><i class="bi bi-check"><BsCheck></BsCheck></i> Duis aute irure dolor in reprehenderit in voluptate velit.</li>
                                    <li><i class="bi bi-check"><BsCheck></BsCheck></i> Facilis ut et voluptatem aperiam. Autem soluta ad fugiat.</li>
                                </ul>
                            </div>
                        </div>
